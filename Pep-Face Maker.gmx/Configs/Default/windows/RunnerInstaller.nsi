...
!ifndef COMPANY_NAME
!define COMPANY_NAME      "Jacko Price"
!endif

!ifndef COPYRIGHT_TXT
!define COPYRIGHT_TXT     "(c)Copyright 2019"
!endif

!ifndef FILE_DESC
!define FILE_DESC         "Level constructor and editor for Pep-Face's Quest"
!endif
...
!ifndef ICON_FILE
!define ICON_FILE       "${MAKENSIS}\Contrib\Graphics\Icons\modern-install.ico"
!endif
...
!ifndef PRODUCT_NAME
!define PRODUCT_NAME      "Pep-faces quest level editor"
!endif
...
Name "${APP_NAME}"
Caption "Pep-face's quest level creator and editor"
...
InstallDir "$PROFILE\Pep-face maker"
...
!define MUI_ICON            "${MAKENSIS}\Contrib\Graphics\Icons\modern-install.ico"
